    ...
    while True: # it needs to be infinitely iterable            
        ...
        for i in range(len(y)):
            ...
            if i > 0 and i % batch_size == 0:
                xval0, xval1, xval2 = embed_elmo(newxval, elmo, xlingual, lang=args.evlang, method='muse')
...
def main():
    ...
    parser.add_argument('--mat0', help='mapping matrices for layer0')
    parser.add_argument('--mat1', help='mapping matrices for layer1')
    parser.add_argument('--mat2', help='mapping matrices for layer2')
